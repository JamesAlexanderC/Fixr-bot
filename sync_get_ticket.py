# ----------------------------------------------------
''' 
Sync version of reserveTickets
'''
# ----------------------------------------------------
...
def run(
    ...
    try:
        before_fields = page.locator('input:visible, select:visible, textarea:visible').count()
        ...
        # STEP 5
        after_fields = page.locator('input:visible, select:visible, textarea:visible').count()
        logger.debug("STEP 5")
    ...
    # STEP 10
    page.locator("button", has_text='Reserve').first.click()
